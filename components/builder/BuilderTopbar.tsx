...
//   onFontSizeChange?: (id: string) => void;
// }
...
//         <div
//           className={[
//             "absolute top-full mt-1 z-50 py-1 bg-rv-white border border-rv-border rounded-sm shadow-[0_12px_32px_rgba(15,14,13,0.12)] min-w-55",
...
//   const activeFontDef =
//     RESUME_FONTS.find((f) => f.id === currentFont) ?? RESUME_FONTS[0];
//   const activeSizeDef =
//     FONT_SIZES.find((s) => s.id === currentFontSize) ?? FONT_SIZES[2];
...
//     setCurrentFont(id);
//     onFontChange?.(id);
//     startTransition(() => updateResumeMeta(resumeId, { font: id }));
//   }

//   function handleFontSizeChange(id: string) {
//     setCurrentFontSize(id);
//     onFontSizeChange?.(id);
//     startTransition(() => updateResumeMeta(resumeId, { fontSize: id }));
//   }
...
//               }
//             }}
//             className="text-sm font-medium bg-transparent border-0 border-b border-rv-accent text-rv-ink outline-none max-w-65 pb-px"
//           />
//         ) : (
//           <button
//             onClick={() => setEditingTitle(true)}
//             className="text-sm font-medium truncate bg-transparent border-0 cursor-text text-rv-ink max-w-65 p-0"
...
//           }
//         >
//           <div className="px-3 py-1.5 text-[0.65rem] font-semibold tracking-widest uppercase text-rv-muted border-b border-rv-border mb-1">
//             Color scheme
//           </div>
...
//             <button className="inline-flex items-center gap-2 text-xs font-medium bg-transparent border border-rv-border rounded-sm px-3 py-1.5 cursor-pointer text-rv-ink hover:border-rv-accent transition-colors duration-150">
//               <FontIcon />
//               <span className="hidden sm:inline">{activeFontDef.label}</span>
//               <ChevronDown />
//             </button>
//           }
//         >
...
//           {["sans", "serif"].map((cat) => (
//             <div key={cat}>
//               <div className="px-3 pt-2 pb-1 text-[0.6rem] font-bold uppercase tracking-widest text-rv-muted/60">
//                 {cat === "sans" ? "Sans-serif" : "Serif"}
//               </div>
//               {RESUME_FONTS.filter((f) => f.category === cat).map((fontDef) => (
//                 <button
//                   key={fontDef.id}
//                   onClick={() => handleFontChange(fontDef.id)}
//                   className={[
//                     "w-full flex items-center justify-between px-3 py-2 text-xs border-0 cursor-pointer text-left transition-colors duration-100 hover:bg-rv-cream",
//                     currentFont === fontDef.id
//                       ? "bg-rv-cream"
//                       : "bg-transparent",
//                   ].join(" ")}
//                 >
//                   <span
//                     className="font-medium text-rv-ink"
//                     style={{ fontFamily: fontDef.stack }}
//                   >
//                     {fontDef.label}
//                   </span>
//                   {currentFont === fontDef.id && (
...
//         {/* Font size control */}
//         <div className="flex items-center gap-0.5 border border-rv-border rounded-sm overflow-hidden">
//           <span className="px-2 text-[0.6rem] font-semibold text-rv-muted uppercase tracking-wider select-none">
//             Size
//           </span>
//           {FONT_SIZES.map((size) => (
//             <button
...
//               title={`${size.label} (${size.scale}×)`}
//               className={[
//                 "px-2 py-1.5 text-[0.65rem] font-semibold border-0 cursor-pointer transition-colors duration-100",
//                 currentFontSize === size.id
//                   ? "bg-rv-accent text-white"
//                   : "bg-transparent text-rv-muted hover:bg-rv-cream hover:text-rv-ink",
//               ].join(" ")}
//             >
//               {size.label}
//             </button>
...
//                   <span
//                     className={`font-medium ${currentTemplate === tmpl.id ? "text-rv-accent" : "text-rv-ink"}`}
//                   >
//                     {tmpl.label}
//                   </span>
...
//                   </div>
//                 </div>
//                 <span className="text-rv-muted mt-0.5 text-[0.7rem]">
//                   {tmpl.description}
//                 </span>
//               </button>
//             );
...
//               <svg
//                 viewBox="0 0 16 16"
//                 className="w-2.5 h-2.5 fill-none stroke-current ml-px"
//                 strokeWidth={1.8}
//               >
//                 <path
//                   d="M4 6l4 4 4-4"
...
//             >
//               <span className="shrink-0 flex" style={{ color: tool.color }}>
//                 {tool.icon}
//               </span>
//               <span>
//                 <span className="block text-[0.75rem] font-semibold text-rv-ink">
//                   {tool.label}
//                 </span>
//                 <span className="block text-[0.65rem] text-rv-muted mt-px">
//                   {tool.desc}
//                 </span>
//               </span>
//             </button>
...
//     >
//       <path
//         d="M2 11L6 3l4 8M3.5 8.5h5M9 3h4M11 3v8"
//         strokeLinecap="round"
//         strokeLinejoin="round"
//       />
//     </svg>
