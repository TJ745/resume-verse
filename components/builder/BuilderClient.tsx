...
export default function BuilderClient({
  ...
  return (
    <>
      ...
      >
        {/* ── Left: Step wizard ── */}
        <div className="w-[420px] shrink-0 border-r border-rv-border bg-rv-paper overflow-hidden flex flex-col">
          <CompletionBar resume={liveResume} sections={sections} />
          <StepWizard
            resume={liveResume}
            sections={sections}
        ...
        <div className="flex-1 overflow-auto bg-rv-cream flex flex-col items-center px-6 py-8 gap-3">
          ...
          <div className="text-[0.6rem] font-semibold tracking-[0.1em] uppercase text-rv-muted">
            Preview · {liveResume.template}
          </div>
          <div className="w-full max-w-[640px] min-h-[900px] bg-[#fdfcfa] shadow-[0_8px_32px_rgba(15,14,13,0.15),0_2px_8px_rgba(15,14,13,0.08)]">
            <ResumePreview
              resume={liveResume}
              sections={sections}
              onSectionsChange={setSections}
