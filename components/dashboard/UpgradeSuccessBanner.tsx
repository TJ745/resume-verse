...
export default function UpgradeSuccessBanner() {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[200] flex items-center gap-2.5 bg-rv-ink text-white px-5 py-3 rounded-[4px] shadow-[0_8px_24px_rgba(15,14,13,0.2)] text-[0.85rem] font-semibold animate-[rv-fade-up_0.3s_ease]">
