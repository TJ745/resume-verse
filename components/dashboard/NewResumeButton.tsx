  ...
  return (
    <>
      ...
      <button
        ...
        className="flex flex-col items-center justify-center gap-3 w-full min-h-60 p-8 bg-transparent border-2 border-dashed border-rv-border cursor-pointer transition-colors duration-200 hover:border-rv-accent hover:bg-[rgba(200,75,47,0.03)]"
      >
      ...
      {open && (
        ...
        >
          <div className="bg-rv-white border border-rv-border rounded-lg p-8 w-full max-w-110 shadow-[0_24px_64px_rgba(15,14,13,0.2)]">
            ...
            <div className="flex gap-2.5 justify-end">
              ...
              <button
                ...
                disabled={isPending}
                className={`px-5 py-2 border-0 rounded-sm text-white text-[0.85rem] font-semibold min-w-32.5 transition-colors ${isPending ? "bg-rv-muted cursor-not-allowed" : "bg-rv-accent cursor-pointer hover:bg-rv-ink"}`}
              >
