...
//   // Strip rawPhotoUrl before saving — it's a large base64 transparent PNG only
//   // used client-side for recompositing when the color scheme changes. Storing it
//   // in the DB would bloat every resume row by 200–500KB unnecessarily.
//   const { rawPhotoUrl: _raw, ...dbPersonalInfo } = personalInfo;

//   await prisma.resume.update({
//     where: { id: resumeId },
//     data: {
//       personalInfo: dbPersonalInfo as object,
