...
// import type { SectionType, SectionContent } from "@/types/resume";
...
// // ── Update resume meta (title, jobTitle, template) ────────
// export async function updateResumeMeta(
//   resumeId: string,
//   data: { title?: string; jobTitle?: string; template?: string },
// ) {
...
// // ── Add a new section ─────────────────────────────────────
// export async function addSection(resumeId: string, type: SectionType) {
//   await requireOwner(resumeId);
...
//       content: defaults[type].content as object,
//       order: existing,
//     },
//   });
...
//   resumeId: string,
//   personalInfo: import("@/types/resume").PersonalInfo,
// ) {
//   await requireOwner(resumeId);
//   await prisma.resume.update({
//     where: { id: resumeId },
